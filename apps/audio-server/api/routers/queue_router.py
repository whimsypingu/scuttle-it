...
from api.dependencies import get_db_manager, get_device_context, get_dl_queue, queue_update_room_broadcast, set_room_active, require_auth
...
QueueRouter = APIRouter(prefix="/queue", tags=["Queue"], dependencies=[Depends(set_room_active), Depends(require_auth)])
