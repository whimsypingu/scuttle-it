...
from api.dependencies import get_db_manager, get_stats_manager, require_auth, track_update_all_broadcast
...
TrackRouter = APIRouter(prefix="/tracks", tags=["Tracks"], dependencies=[Depends(track_update_all_broadcast), Depends(require_auth)])
